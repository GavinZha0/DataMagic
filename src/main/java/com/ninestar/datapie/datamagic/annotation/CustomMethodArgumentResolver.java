package com.ninestar.datapie.datamagic.annotation;
...
public class CustomMethodArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public boolean supportsParameter(MethodParameter parameter) {
        ...
        return parameter.hasParameterAnnotation(SingleReqParam.class);
    }
    ...
    private Object bindRequestParams(MethodParameter parameter, HttpServletRequest servletRequest) {
        SingleReqParam customParam = parameter.getParameterAnnotation(SingleReqParam.class);
