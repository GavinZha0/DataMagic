...
public enum DatabaseType {
    ...
    DatabaseType(String feature, String desc, String driver, String keywordPrefix, String keywordSuffix, String aliasPrefix, String aliasSuffix) {
    ...
    public static DatabaseType urlOf(String jdbcUrl) throws Exception {
        String url = jdbcUrl.toLowerCase().trim();
        for (DatabaseType databaseType : values()) {
            if (url.startsWith(String.format("jdbc:%s:", databaseType.feature))) {
                return databaseType;
            }
        }
        return null;
